...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/game', name: 'game-home', component: () => import('@/views/GameHomeView.vue') },
    { path: '/game/famous', name: 'game-famous', component: () => import('@/views/GameFamousCreateView.vue') },
    { path: '/game/random', name: 'game-random', component: () => import('@/views/GameRandomCreateView.vue') },
    { path: '/game/timeline/:id', name: 'game-timeline', component: () => import('@/views/GameTimelineView.vue') },
